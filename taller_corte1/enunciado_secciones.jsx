        ...
        const INDIVIDUAL = [
            ['I1', 'Sustentación dirigida', 50, 'sábado 5 de septiembre'],
            ['I2', 'Control presencial de transferencia, sin IA', 30, 'sábado 29 de agosto'],
        ...
        const EncuadreSection = () => (
            <div>
                ...
                <Box type="warn" label="Control presencial — sábado 29 de agosto, 10 minutos, sin IA">
