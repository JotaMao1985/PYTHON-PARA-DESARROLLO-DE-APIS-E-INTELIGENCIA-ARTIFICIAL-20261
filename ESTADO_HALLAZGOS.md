...
| C7 | 1 | cosmético | 2, 6, 7, 10, 13 | Bloques de código que continúan a otro sin decirlo | ✔ cerrado | Auditoría | — |
...
| P6 | 2 | importante | 7 | 128 min de prosa contra un presupuesto de 60 | ✔ cerrado | Fase 3 | `eca3261` |
...
| P14 | 2 | importante | 1, 7, 13 | No se dirigen al estudiante ni una vez | ✔ cerrado | Fase 3 | `eca3261` |
