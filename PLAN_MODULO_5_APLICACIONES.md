...
| R4 | ~~Remontar el módulo 6 borraría T5, que era una edición manual del publicado~~ **Cerrado el 2026-09-09**: la guía reducida está también en `heredado/6_…html`, y montar la receta reproduce el publicado carácter a carácter. La sangría tampoco es ya motivo (`ab829ff`) | — | — |
